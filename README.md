...
[Fontra Pak](https://github.com/BlackFoundryCom/fontra-pak) is a Fontra distribution for macOS and Windows. It is a self-contained Fontra server application, which allows you to view and edit fonts in the default browser. We don't have releases for it yet, but you can grab the latest nightly build from the [“Build Application”](https://github.com/BlackFoundryCom/fontra-pak/actions) workflow.
