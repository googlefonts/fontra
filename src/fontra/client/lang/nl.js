...
export const strings = {
  ...
  "application-settings.shortcuts.dialog.reset-all.title": "Reset to default",
  "application-settings.shortcuts.dialog.warning.title": "Shortcuts warning",
  "application-settings.shortcuts.export": "Export shortcuts",
  "application-settings.shortcuts.import": "Import shortcuts",
  "application-settings.shortcuts.reset-all": "Reset all shortcuts",
  "application-settings.shortcuts.title": "Snelkoppelingen",
  "application-settings.shortcuts.tooltip.clear": "Clear",
  "application-settings.shortcuts.tooltip.click-and-record":
    "Click and record a shortcut",
  "application-settings.shortcuts.tooltip.reset-to-default": "Reset to default",
  "application-settings.shortcuts.warning.exists": "Shortcut exists for: %0",
