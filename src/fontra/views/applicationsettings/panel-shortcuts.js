...
function _shortcutPropertiesContentElement(controller) {
  ...
  const contentElement = html.div(
    ...
    [
      ...
      html.div(),
      labeledCheckbox(`Ctrl Key (${getNiceKey("Ctrl")})`, controller, "ctrlKey", {}),
      html.div(),
      labeledCheckbox(`Alt Key (${getNiceKey("Alt")})`, controller, "altKey", {}),
      html.div(),
      labeledCheckbox(`Shift Key (${getNiceKey("Shift")})`, controller, "shiftKey", {}),
      html.div(),
      labeledCheckbox(`Meta Key (${getNiceKey("Meta")})`, controller, "metaKey", {}),
      html.div(),
